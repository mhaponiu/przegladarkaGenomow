...
Data about markers and contigs allowed to map sequenced genome onto chromosomes. Contigs were mapped based on Chinese markers\cite{ren2009integrated} . Not every contig has been mapped successfully. Tab.\ref{tab:genome_stat} shows obtained mapping results.
...
\begin{table}
	...
	\caption{Chromosome statistic for mapped contigs of Nothern European cucumber genome.
      The length of the chromosomes and length of the genome described in~Chen's studies\cite{chen1998reevaluation} was used.}
...
We thank M.Sc Paweł Osipowski and M.Sc Michał Wojcieszek for helpful comments and analysis.
