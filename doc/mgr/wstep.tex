...
\section{Artykuł}
Powstał artykuł naukowy, w którym m.in. została zaprezentowana przeglądarka zaimplementowana w ramach pracy magisterskiej.
\begin{center}
	\textit{\textbf{CuGene as a tool to view and explore genomic data}}
\end{center}

\begin{scriptsize}
	\begin{spacing}{1.5}
	Michał Haponiuk\textsuperscript{A}, Magdalena Pawełkowicz\textsuperscript{B}, Zbigniew Przybecki\textsuperscript{B}, Robert M.Nowak\textsuperscript{A}\\
	\textsuperscript{A}Insitute of Computer Science, Warsaw University of Technology; Nowowiejska 15/19, 00-665, Warsaw, Poland\\
	\textsuperscript{B}Department of Plant Genetics, Breeding and Biotechnology, Warsaw University of Life Sciences; Nowoursynowska 159, 02-776, Warsaw, Poland
	\end{spacing}
\end{scriptsize}

Praca została zaprezentowana 01.06.2017 o godz. 11:15 w bloku bioinformatycznym na 40 sympozjum Wilga 2017 (XL-th IEEE-SPIE Joint Symposium Wilga 2017 \textit{http://wilga.ise.pw.edu.pl}).
